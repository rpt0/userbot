...
__MODULES__ = "Instargam"

def help_string(org):
    return h_s(org, "help_instagram")
...
@zb.ubot("ig")
async def instacrot(client: Client, message, *args):
    print("processing")
    ...
    try:
        ...
        try:
            ...
            await message.reply_text(
                "<blockquote>400: Sorry, Unable To Find It  try another or report it  to @Priaindiareal or support chat @bakuzaan 🤖</blockquote>"
            )
        finally:
            await m.delete()
